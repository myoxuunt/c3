        ...
        static public TemperatureControlModeCollection TemperatureControlModeCollection
        {
            get
            {
                if (_temperatureControlModeCollection == null)
                {
                    ...
                    m = new TemperatureControlMode(CZGR1.XD100.XD100Strings.OTGT2ControlLine, TemperatureControlModeEnum.OT_GT2);
                    _temperatureControlModeCollection.Add(m);
                    m = new TemperatureControlMode(CZGR1.XD100.XD100Strings.TimeControlLine, TemperatureControlModeEnum.Time_GT2);
                    _temperatureControlModeCollection.Add(m);
                }
        ...
        static public ValveTypeCollection ValveTypeCollection
        {
            get
            {
                if (_valveTypeCollection == null)
                {
                    ...
                    ValveType v = null;
                    v = new ValveType(CZGR1.XD100.XD100Strings.AnalogValve, ValveTypeEnum.AnalogValve);
                    _valveTypeCollection.Add(v);
                    v = new ValveType(CZGR1.XD100.XD100Strings.TrinityValve, ValveTypeEnum.TrinityValve);
                    _valveTypeCollection.Add(v);
                }
